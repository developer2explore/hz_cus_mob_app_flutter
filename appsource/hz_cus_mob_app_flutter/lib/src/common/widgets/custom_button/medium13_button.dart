...
class Medium13Button extends StatefulWidget {
  final String text;
  ...
  const Medium13Button({
    ...
    this.textColor, // Initialize the optional parameter for text color
  ...
  @override
  State<Medium13Button> createState() => _Medium13ButtonState();
}

class _Medium13ButtonState extends State<Medium13Button> {
  bool isHovered = false;

  get textColor async => AppColors.whiteColor;
          ...
          child: SizedBox(
            ...
            child: Center(
              child: Text(widget.text,
                  style: AppTextStyles.getMedium13Style(textColor: textColor)),
            ),
          ),
        ),
      ),
